              ...
              <div className="lg:pl-20">
                <div className="pb-6 mb-8 border-b border-gray-200 dark:border-gray-700">
                  ...
                  <div className="p-4 mb-8 border border-gray-300 dark:border-gray-700">
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-2.5  dark:bg-gray-600">
                      <div className="bg-blue-600 dark:bg-blue-400 h-2.5 rounded-full">
                      </div>
                    </div>
                  </div>
                ...
                <div className="mb-8">
                  ...
                  <div className="flex flex-wrap -mb-2">
                    ...
                    <button
                      className="p-1 mb-2 border border-transparent rounded-full hover:border-gray-400 dark:border-gray-800 dark:hover:border-gray-400">
